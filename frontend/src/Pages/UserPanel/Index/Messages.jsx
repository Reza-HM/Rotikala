  ...
  return (
    <div className="w-full flex-1 lg:flex-[3] bg-white dark:bg-zinc-900 text-slate-600 dark:text-slate-300 mt-8 rounded-xl shadow-lg p-8">
      <div className="flex justify-between items-center">
        <h1 className="text-4xl pb-6 w-24 rounded-md border-b-4 border-emerald-400 text-slate-600 dark:text-white">
          پیام‌ها
        </h1>
      ...
      <div className="flex w-full items-center xs:w-60 float-left gap-4 bg-emerald-400 hover:bg-emerald-400/90 rounded-lg mt-8 p-4 text-white cursor-pointer">
        پیگیری سفارش
        <FaAngleLeft />
      </div>
    </div>
