...
const Index = () => {
  return (
    <div className="w-full flex-1 lg:flex-[3] bg-white dark:bg-zinc-900 text-slate-600 dark:text-slate-300 mt-8 rounded-xl shadow-lg p-8">
      <h1 className="text-4xl pb-6 w-32 rounded-md border-b-4 border-emerald-400 text-slate-600 dark:text-white">
        پیشخوان
      </h1>
      <div className="my-20">
        <h2 className="flex items-center gap-8">
          <span className="w-4 h-4 bg-emerald-400 rounded-full"></span>
          حساب کاربری
        </h2>
        <div className="grid grid-cols-2 2xl:grid-cols-4 mt-12 gap-8">
          ...
          >
            <div className="p-4 m-3 bg-emerald-500/50 rounded-xl">
      ...
      <div className="my-20">
        ...
        <div className="shadow-lg p-8 rounded-xl mt-12">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4 text-3xl text-emerald-500/70 dark:text-emerald-500">
              <AiOutlineCheckCircle className="text-5xl" />
              پرداخت شده
            </div>
            <FaAngleLeft className="text-4xl text-emerald-500/70 dark:text-emerald-500" />
          </div>
