...
const Addresses = () => {
  ...
  return (
    <div className="w-full flex-1 lg:flex-[3] bg-white dark:bg-zinc-900 text-slate-600 dark:text-slate-300 mt-8 rounded-xl shadow-lg p-8">
      <h1 className="text-4xl pb-6 w-28 rounded-md border-b-4 border-emerald-400 text-slate-600 dark:text-white">
        آدرس‌ها
      </h1>
      ...
      <button className="bg-emerald-400 float-left mt-16 text-white py-2 px-4 rounded-lg hover:bg-emerald-400/90">
        ثبت آدرس جدید
      </button>
    </div>
  );
