    ...
    <div className="px-8 sm:container text-slate-600 dark:text-slate-300 flex flex-col mb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8 bg-white dark:bg-zinc-900 rounded-lg shadow-lg p-12">
        ...
        <div className="flex flex-col gap-8">
          <div className="flex items-center gap-4 text-2xl text-emerald-400">
            نایک
            <FaAngleLeft />
          </div>
          ...
          <div className="text-emerald-400 flex items-center gap-4 text-2xl">
        ...
        <div className="flex flex-col gap-32">
          ...
          <div className="flex flex-col gap-12">
            <div className="bg-emerald-500/10 rounded-xl dark:bg-emerald-400/5 p-4 flex items-center gap-4 text-emerald-400">
      ...
      <div className="p-8 rounded-xl bg-white dark:bg-zinc-900 shadow-lg mt-8">
        <ul className="flex items-center gap-12 dark:text-white">
          ...
          <li className="relative cursor-pointer transition-all duration-300 ease-linear hover:text-slate-300">
            دیدگاه‌ها
            <div className="absolute -top-8 -left-4 w-10 h-10 rounded-[50%] flex justify-center items-center bg-emerald-400 text-lg font-bold">
              2
            </div>
          </li>
        </ul>
        <div className="mt-24">
          <h1 className="text-3xl font-bold border-b-4 rounded-lg pb-4 w-20 border-emerald-400 dark:text-white">
            معرفی
          </h1>
        ...
        <div className="mt-32">
          <h1 className="text-3xl font-bold border-b-4 rounded-lg pb-4 w-32 border-emerald-400 dark:text-white">
            مشخصات
          </h1>
        ...
        <div className="mt-32">
          <h1 className="text-3xl font-bold border-b-4 rounded-lg pb-4 w-28 border-emerald-400 dark:text-white">
            دیدگاه‌ها
          </h1>
            ...
            <div className="flex-1 flex flex-col gap-8  sm:sticky top-40 h-[42rem]">
              ...
              <div className="mt-8">
                ...
                <div className="flex items-center justify-between w-full gap-8 mt-8">
                  <div className="flex items-center w-full justify-center gap-4 text-3xl text-emerald-400 cursor-pointer py-4 px-8 shadow-lg rounded-xl">
                    <FiThumbsUp />
                    می‌کنم
                  </div>
              ...
              <button className="bg-emerald-500 text-white w-full rounded-xl p-4 cursor-pointer hover:bg-emerald-500/80 flex justify-center">
                ارسال دیدگاه
              </button>
            </div>
