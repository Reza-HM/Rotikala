...
const MegaMenu = ({ setMenuStatus }) => {
  ...
  return (
    <>
      <div className="absolute mega-menu z-50 px-8 md:px-0 top-full right-0 left-0 sm:w-full max-w-[1000px] border-t-4 border-emerald-400 transition-all duration-200 ease-in-out ">
        <div
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:h-[450px] max-h-[450px] w-full overflow-hidden rounded-b-lg pt-0.5">
            ...
            >
              ...
              >
                <li className="text-white rounded-xl hover:bg-emerald-400">
                  <Link
                ...
                <li className="text-white  hover:bg-emerald-400 rounded-xl">
                  <Link
              ...
              <div className="flex flex-grow" dir="rtl" id="mega-menu-childs">
                {selectedCategory === null && (
                  <div className=" p-5">
                    <div className="mb-4">
                      <Link
                        className="flex items-center gap-x-1 py-2 text-md text-emerald-500 dark:text-emerald-400"
                        to="/allproducts"
                      >
                    ...
                    <div className="flex flex-grow flex-wrap gap-x-14 gap-y-8">
                      <div className="space-y-2">
                        <Link
                          className="flex items-center gap-x-2 text-zinc-700 hover:text-emerald-500 dark:text-white hover:dark:text-emerald-400"
                          to="/allproducts"
                        >
                          <span className="h-5 w-0.5 rounded-full bg-emerald-500 dark:bg-emerald-500"></span>
                          <div>لباس مردانه</div>
                        </Link>
                        <ul>
                          {mensCategory
                            ...
                            .map((clothes) => (
                              <li>
                                <Link
                                  className="block py-2 text-md text-zinc-600 hover:text-emerald-500 dark:text-zinc-300 hover:dark:text-emerald-400"
