    ...
    <>
      ...
      <div className="z-40 absolute hidden top-32 left-10 bottom-auto m-0 !ml-5 w-[20rem] overflow-hidden rounded-xl shadow-lg border-t-2 border-t-emerald-500 bg-white dark:border-t-emerald-400 dark:bg-zinc-800 lg:block">
        <ul className="space-y-1 p-2">
          <li>
            <Link
              className="flex items-center justify-between gap-x-2 rounded-lg p-4 text-slate-600 hover:text-emerald-500 dark:text-slate-300 dark:hover:text-emerald-400"
          ...
          <li>
            <Link className="flex items-center justify-between rounded-lg p-4 text-slate-600 hover:text-emerald-500 dark:text-slate-300 dark:hover:text-emerald-400">
          ...
          <li>
            <Link
              className="flex items-center justify-between rounded-lg p-4 text-slate-600 hover:text-emerald-500 dark:text-slate-300 dark:hover:text-emerald-400"
            ...
            >
              ...
              <span className="relative flex h-8 w-8">
                ...
                <span className="relative inline-flex h-full w-full items-center justify-center rounded-full bg-emerald-500 text-sm text-white dark:text-white">
                  2
                </span>
              </span>
            </Link>
