  ...
  return (
    <div className="sticky top-44 h-screen mt-20 xs:mt-0 sm:mt-12 lg:mt-0 p-8 space-y-12 bg-white dark:bg-zinc-900 overflow-y-scroll overflow-x-hidden shadow-lg rounded-2xl hidden md:block">
      <div className="flex justify-between items-center">
        ...
        <h2 className="text-2xl text-emerald-400 cursor-pointer">حذف همه</h2>
      </div>
      <ul className="space-y-14">
        <li className="relative">
          ...
          />
          <button className="absolute left-0 bg-emerald-400 text-white rounded-e-lg p-4 hover:bg-emerald-400/90">
            جستجو
          </button>
        </li>
        <li>
          <div className="flex flex-col gap-8">
            ...
            <input
              ...
              className="slider appearance-none w-full h-2 rounded-full bg-emerald-400 accent-emerald-600 dark:accent-slate-300 cursor-pointer outline-none"
            />
            <div className="space-y-8">
              <div className="flex items-center justify-between">
                <div className="text-emerald-500 dark:text-emerald-400 flex gap-2 items-center">
        ...
        <li className="flex items-center flex-col gap-4 cursor-pointer">
          <div
            className="w-full flex justify-between items-center gap-4 hover:text-emerald-400 transition-all duration-200 ease-linear"
        ...
        <li>
          <div
            className="w-full flex justify-between items-center cursor-pointer hover:text-emerald-400 transition-all duration-200 ease-linear"
        ...
        <li>
          ...
          >
            ...
            <div className="relative inline-flex cursor-pointer items-center">
              ...
              <div className="peer h-9 w-16 rounded-full bg-gray-500 dark:bg-slate-200 after:absolute after:left-[2px] after:top-0.5 after:h-7 after:w-7 after:rounded-full after:bg-white after:transition-all after:content-[''] peer-checked:bg-emerald-500 peer-checked:after:translate-x-full peer-focus:ring-emerald-500 after:dark:bg-slate-600 peer-checked:dark:bg-emerald-400 peer-focus:dark:ring-emerald-400"></div>
            </div>
          </label>
        </li>
        <li>
