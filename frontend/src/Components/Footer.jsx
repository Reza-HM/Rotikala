    ...
    <footer className="px-6 relative border-t w-full rounded-t-2xl border-gray-100 bg-white dark:bg-zinc-900">
      ...
      <div className="flex flex-wrap dark:bg-black gap-8 justify-center md:justify-between items-center py-8 px-16 my-12 bg-gray-100 rounded-2xl shadow-2xl backdrop-blur-3xl">
        ...
        <div className="relative w-[400px] py-4 px-6 bg-white dark:bg-zinc-800 dark:text-slate-300 rounded-xl shadow-md">
          ...
          />
          <button className="absolute -bottom-16 left-[3rem] xs:left-2 xs:top-2 xs:bottom-2 bg-emerald-400 py-3 px-5 text-2xl rounded-2xl font-bold text-white hover:bg-emerald-300 transition-all duration-200 ease-linear">
            ثبت
          </button>
        </div>
        <div className="flex items-center mt-12 sm:mt-0 gap-8">
          <FaXTwitter className="text-4xl cursor-pointer dark:text-white hover:text-emerald-400 hover:dark:text-emerald-400 transition-all duration-300 ease-linear" />{" "}
          <SiAparat className="text-4xl cursor-pointer dark:text-white hover:text-emerald-400 hover:dark:text-emerald-400 transition-all duration-300 ease-linear" />{" "}
          <AiOutlineInstagram className="text-4xl cursor-pointer dark:text-white hover:text-emerald-400 hover:dark:text-emerald-400 transition-all duration-300 ease-linear" />
        </div>
      </div>
        ...
        <div className="flex gap-4 sm:gap-60">
          <div className="flex flex-col gap-12">
            ...
            <ul className="space-y-8">
              <li className="text-2xl font-bold text-slate-400 hover:text-emerald-400 cursor-pointer transition-all duration-200 ease-linear">
                شرایط مرجوعی
              </li>
              <li className="text-2xl font-bold text-slate-400 hover:text-emerald-400 cursor-pointer transition-all duration-200 ease-linear">
                راهنمای خرید
